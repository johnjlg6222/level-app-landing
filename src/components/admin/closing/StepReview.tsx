...
import {
  CheckCircle, Package, Layers, FileText, Download,
  Save, Sparkles, Building2, User, Mail, Phone, Palette,
} from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">
          Verifiez toutes les informations avant de generer le devis final.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card variant="filled" padding="md">
            ...
            <div className="space-y-2 text-sm">
              ...
              {state.projectContext.problemToSolve && (
                <p className="text-gray-300">
                  <span className="text-gray-500">Probleme: </span>
                  {state.projectContext.problemToSolve}
                </p>
              )}
            </div>
          ...
          <Card variant="filled" padding="md">
            ...
            <div className="space-y-2">
              ...
              {selectedCategoryPacksData.map((pack) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <Badge variant="default" size="sm">Categorie</Badge>
                    <span className="text-sm font-medium text-white">
                      {pack.name}
                    </span>
                    <Badge variant="default" size="sm">
              ...
              {!selectedMainPackData && selectedCategoryPacksData.length === 0 && (
                <p className="text-sm text-gray-500">Aucun pack selectionne</p>
              )}
            </div>
          </Card>
          ...
          {packFeatures.length > 0 && (
            <Card variant="filled" padding="md">
              <h3 className="text-base font-semibold text-white mb-3 flex items-center gap-2">
                ...
                Fonctionnalites incluses dans les packs
              </h3>
        ...
        {/* Right: Price summary (1 col) */}
        <div className="space-y-4">
          <div className="sticky top-4">
            <PriceSummaryPanel calculatedPrice={calculatedPrice} />
