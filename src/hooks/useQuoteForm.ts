...
export function useQuoteForm() {
  ...
  // Build the pricing input (used by both sync and async calculators)
  ...
  }), [state.selectedPlan, state.selectedPacks, state.selectedFeatures, state.extraScreens, state.discount, state.logistics.urgency, state.logistics.maintenance]);
